...
raw_counts <- GetAssayData(etv6_runx1_1,
                           assay = "RNA",
                           layer = "counts")
```
...
multi_raw_counts <- GetAssayData(multi_seurat_object,
                                 assay = "RNA",
                                 layer = "counts")
...
filt_raw_counts <- GetAssayData(filtered_multi_seurat_object, assay = "RNA", layer = "counts")
